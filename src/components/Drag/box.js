...
export default function Box(props) {
  ...
  return (
    ...
    <div data-toggle="tooltip" data-placement="top" title={item.source ? `source: ${item.source}, address: ${item.provided}, note: ${item.note || 'Not provided'} ` : item.fullName} ref={drag} className={`media ${className}`} >
